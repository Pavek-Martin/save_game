...
$adresar_kam="C:\Users\DELL\Documents\zaloha\save_hry\prey\"
...
$name = "$datum-prey_save-backup.zip"
...
Compress-Archive -Path "C:\Users\DELL\Documents\My Games\PREY" -CompressionLevel Optimal -DestinationPath "$adresar_kam$name"
sleep 6
